...
const BACKGROUNDS = [
    ...
    },
    {
        ...
        draw(ctx, w, h) {
            ...
            for (const [x, y, bw, bh] of buildings) ctx.fillRect(x*w, y*h, bw*w, bh*h);
...
// Discord addChoices() hard limit is 25.
// We expose the 25 most commonly used backgrounds as dropdown choices.
// All 32 are still accessible via the render engine (template system, /brand ai, etc.).
const CHOICE_IDS = [
    'gradient-purple', 'gradient-blue', 'gradient-red', 'gradient-green',
    'gradient-gold', 'gradient-teal', 'gradient-pink', 'gradient-orange',
    'solid-black', 'solid-white', 'solid-dark',
    'noise-dark', 'grid-dark', 'dots-dark', 'radial-purple', 'radial-blue',
    'inferno', 'deep-space', 'twilight', 'aurora',
    'void', 'neon-city', 'polar', 'forest-night', 'storm',
];
...
// Returns exactly 25 choices for Discord slash command dropdowns
function getBackgroundChoices() {
    return BACKGROUNDS
        .filter(b => CHOICE_IDS.includes(b.id))
