/**
 * /logo — Generate a 400×400 logo icon
...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('logo')
        .setDescription('Generate a 400\u00d7400 logo icon.')
        .addStringOption(o =>
            o.setName('text')
        ...
        .addStringOption(o =>
            o.setName('border')
             .setDescription('Frame style around the edge of the logo (default: None)')
             .setRequired(false)
    ...
    async execute(interaction) {
        ...
        const reply = await interaction.reply({
            embeds: [new EmbedBuilder().setColor('#808080').setDescription('\u2726 Generating your logo\u2026')],
        });
        ...
        try {
            ...
            await reply.edit({
                embeds: [new EmbedBuilder()
                    ...
                    .setFooter({ text: `Sigil \u2022 /logo \u2022 ${background} \u2022 ${colorLabel} \u2022 font:${font.label}` })],
                files: [new AttachmentBuilder(buffer, { name: 'logo.png' })],
            });
        } catch (err) {
            console.error('[ERROR] Logo generation failed:', err);
            await reply.edit({
